...
/**
    ...
    public function wplk_settings_init() { 
        ...
        add_settings_section(
            ...
            esc_html__('LaunchKit Options', 'wplk'),
    ...
    public function wplk_options_page() {
        ...
        <div id="wplk-page">
            ...
            <nav class="nav-tab-wrapper">
                ...
                <a href="?page=wplk&tab=installer" class="nav-tab <?php if ($tab === 'installer'): ?>nav-tab-active<?php endif; ?>"><?php esc_html_e('Install & Update', 'wplk'); ?></a>
                <a href="?page=wplk&tab=featured" class="nav-tab <?php if ($tab === 'featured'): ?>nav-tab-active<?php endif; ?>"><?php esc_html_e('More Features', 'wplk'); ?></a>
            </nav>
            ...
            <div class="wplk-wrap">
                <div class="tab-content">
                    ...
                    case 'documentation': ?>
                        <div class="wplk-dashboard__content">
                            <div class="wplk-inner">
                                <h1><?php esc_html_e('Documentation & More', 'wplk'); ?></h1>
                                <br/>
                                <div class="wplk-settings-container">
                                    <h3>Documentation & Minute Launch Guide</h3>
                                    <p>Browse The Documentation Or Use The Minute Launch Guide</p>
                                    <a href="https://wplaunchkit.com/documentation" class="wplk-button" target="_blank">Documentation</a>
                                    <a href="https://wplaunchkit.com/documentation/what-to-expect-after-purchasing-the-wplauchkit/" class="wplk-button" target="_blank">Minute Launch Guide</a>                     
                                </div>

                                <ul class="wplk-downloads">
                                    <li>
                                        <h3>Latest Content</h3>
                                        <p>Video Training For <strong>LaunchKit</strong></p>
                                        <a class="wplk-button" href="https://wplaunchify.com/#latest-content" target="_blank">Video Training</a>
                                    </li>
                                    <li>
                                        <h3>Office Hours & Email Help</h3>
                                        <p>Every Friday @10am Central (Chicago)</p>
                                        <a href="https://wplaunchkit.com/#live" class="wplk-button" target="_blank">Attend FREE</a>
                                        <a href="https://wplaunchify.com/#contact" class="wplk-button" target="_blank">Contact Us</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    case 'settings': ?>
                        <div class="wplk-dashboard__content">
                            <div class="wplk-inner">
                                <h1><?php esc_html_e('LaunchKit Settings', 'wplk'); ?></h1>
                                <br/>
                                <style>
                                ...
                                <div class="wplk-settings-container">
                                    ...
                                    <div style="text-align:left!important; width:80%; margin:0 auto;">
                                        <p>Shouldn't WordPress be easier than it is? Rather than a bunch of parts that come from random providers...what if you had a curated experience like you get from IKEA or LEGO? Where you have a guarantee that everything snaps together, while being delivered and supported as a system. Enter LaunchKit.</p>
                                        <p> For free you can take back control over your WordPress sites (for yourself or your clients) with a set of powerful admin controls. But for the real "magic", you can acquire all of the software, with automatic updates and expert support, to most all of your business site needs. Pay once, pay monthly, or annually...either way, you'll be able to launch in minutes!</p>

                                        <h3>Just Three Steps!</h3>
                                        <ul>
                                            <li><strong>Step One:</strong> Set Your <a href='#launchkit'>LaunchKit Admin Options</a></li>
                                            <li><strong>Step Two:</strong> Create Your  <a href='https://wplaunchify.com/#pricing' target='_blank'>LaunchKit Membership Account</a></li>
                                            <li><strong>Step Three:</strong> Login To <a href='/wp-admin/admin.php?page=wplk&tab=installer'>Install & Update Your Software</a></li>
                                        </ul>
                                    </div>
                                </div>
<style>
                    ...
                    case 'featured': ?>
                        <div class="wplk-dashboard__content">
                            <div class="wplk-inner">
                                <h1><?php esc_html_e('More Features', 'wplk'); ?></h1>
                                <p>Access our other features and services below</p>
                                ...
                                <nav class="nav-tab-wrapper-more">
                                    ...
                                    <a href="?page=wplk&tab=license" class="nav-tab <?php if ($tab === 'license'): ?>nav-tab-active<?php endif; ?>"><?php esc_html_e('License', 'wplk'); ?></a><span class="nav-description">Manage the included software licenses.</span>
                                    ...
                                    <a href="?page=wplk&tab=documentation" class="nav-tab <?php if ($tab === 'documentation'): ?>nav-tab-active<?php endif; ?>"><?php esc_html_e('Documentation', 'wplk'); ?></a><span class="nav-description">For all questions and support.</span>
                        ...
                        <div class="wplk-dashboard__content">
                            <div class="wplk-inner">
                                ...
                                <div class="wplk-settings-container">
                                    ...
                                    <h2>Get Your LaunchKit Account</h2>
                                    <p> LaunchKit is available from WPLaunchify with <a href="https://wplaunchify.com/#pricing" target="_blank">plans and pricing</a> to fit everyone's needs and budget.<br/>Whether software only, with email support, or hands-on "done for you" services.</p>
                                    <p><a href="https://wplaunchify.com/#pricing" class="wplk-button wplk-featured"target="_blank">Get Your LaunchKit Account Now!</a></p>
                                </div>
