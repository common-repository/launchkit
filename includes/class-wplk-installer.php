...
public function launchkit_packages_menu() {
    ...
    <div id="wpbody" role="main">
        <div id="wpbody-content">
            ...
            <p>Log in to retrieve, install or update all the latest software for your site.<br/><em>*Use your login credentials from <a href="https://wplaunchify.com" target="_blank">WPLaunchify</a></em></p>
